Vue.component('modal-registrar', {
    ...
    template: `<div :class="['ui','modal',tamanio]" :id="id">
                ...
                <div class="content">
                    ...
                    <form onsubmit="return false;" class="ui equal width form" :id="id_form">
                        <div v-for="campo in campos" class="field">
                            ...
                            <select class="ui search dropdown" v-if="campo.type == 'select'" :name="campo.name" :id="campo.name">
                ...
                <div class="actions">
                    ...
                    <button type="button" id="btnRegistrar" class="ui right red button" @click="registrar" >
                        Registrar
                    </button>
                </div>
            </div>`
