...
<div class="ui grid">
        <div class="row">
            ...
            <a href="?1=OTController&2=impresion" class="ui black button" id="imp" style="font-weight:bold;">Impresión Digital</a>
...
<div class="ui divider"></div><br>
    ...
    <div class="field">
        ...
        <div class="two wide field">
            ...
            <input type="radio" name="tipo" value="Tiro"> Tiro &nbsp; &nbsp; &nbsp;
            <input type="radio" name="tipo" value="Retiro"> Retiro
            </div>
