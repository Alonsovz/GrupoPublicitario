<?php
    ...
    header('Content-Disposition: attachment; filename=inventarioImpDi.xls');
    ...
    p.*,cp.nombre as nombre from inventario i
        ...
        where cp.idClasificacion=2
        group by i.idProducto,i.idColor,i.idAcabado";
	$result=mysqli_query($link, $query);
?>
<center><h1 style="margin:auto;">Inventario de productos de Impresi&oacute;n Digital</h1>
