...
<div class="ui grid">
        <div class="row">
            ...
            Órdenes de Trabajo  de Impresión digital pendientes de aprobación del cliente </font><font color="black" size="20px">.</font>
            </div>
        </div>
</div>
...
<script src="./res/tablas/tablaPenClientesIP.js"></script>
<script>
...
$("#btnFinalizar").click(function(){
    ...
    $.ajax({
                ...
                url: '?1=OTController&2=aprobarOrdenIP',
                data: {id:id,},
                success: function(r) {
                    if(r == 1) {
