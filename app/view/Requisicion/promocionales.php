...
<div class="ui grid">
        ...
        <div class="titulo">
                ...
                <i class="plus icon"></i> <i class="list icon"></i>
                   Requisición de Productos promocionales </font><font color="black" size="20px">.</font>
                </div>
        </div>
            ...
            <div class="field">
                <div class="fields">
                    ...
                    <div class="four wide field">
                        ...
                        <input type="hidden" id="idClasi" name="idClasi" value="3">
                    </div>
