<div id="app">
    <div class="ui grid">
            <div class="row">
                    <div class="titulo">
                    <a href="?1=RequisicionController&2=rechazadasGF" class="ui gray button" id="gr" style="color:black; font-weight:bold;">
                    Gran Formato</a>

                    <a href="?1=RequisicionController&2=rechazadasIP" class="ui black button" id="imp">Impresión Digital</a>

                    <a href="?1=RequisicionController&2=rechazadasP" class="ui red button" id="pro">Promocionales</a>
                    <a href="?1=RequisicionController&2=gastosRechazados" class="ui blue button" id="gast">Gastos de Oficina</a>
                    <br><br>

                    <font color="#848484" size="5px">
                    <i class="user icon"></i> <i class="list icon"></i>
                        Requisición de productos de Gran Formato rechazadas</font><font color="black" size="20px">.</font>
                    </div>
            </div>
...
<script src="./res/tablas/tablaRechazadasGF.js"></script>
    <script>
