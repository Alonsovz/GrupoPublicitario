...
<modal-registrar id_form="frmRegistrar" id="modalRegistrar" url="?1=ProductosController&2=registrarI" titulo="Registrar producto"
    ...
    <modal-eliminar id_form="frmEliminar" id="modalEliminar" url="?1=ProductosController&2=eliminar" titulo="Eliminar producto"
        ...
        <div class="row">
                ...
                <a href="?1=ProductosController&2=granFormato" class="ui gray button" id="gr">Gran Formato</a>
                    <a href="?1=ProductosController&2=impresion" class="ui black button" id="imp" style="font-weight:bold;">Impresión Digital</a>
                    <a href="?1=ProductosController&2=promocionales" class="ui red button" id="pro">Promocionales</a>
                    <br><br>
                <font color="black" size="6px">
                <i class="calendar check outline icon"></i> <i class="truck icon"></i>
                    Productos de Impresión digital </font><font color="black" size="20px">.</font>
                </div>
        </div>
        ...
        <div class="row">
            <div class="sixteen wide column">
                <table id="dtImpresion" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        <tr>
                        
                            <th style="background-color: black; color:white;">N°</th>
                            <th style="background-color: black; color:white;">Nombre del producto</th>
...
<div class="header" style="font-size:18px; text-align:center; background-color:#FACA8C;font-weight:bold;">
<i class="pencil icon"></i> Colores disponibles en Productos de Impresión Digital
</div>
...
<div class="header" style="font-size:16px; text-align:center; background-color:#89DE5F;font-weight:bold;">
<i class="podcast icon"></i> Lista de acabados disponibles en Productos de Impresión Digital
</div>
<div class="scrolling content" style="background-color:#EBEAE8;">
<form class="ui form">
<div class="field">
...
<div class="header" style="font-size:18px; text-align:center; background-color:#D6A7F4;font-weight:bold;">
<i class="arrows alternate icon"></i> Medidas disponibles en Productos de Impresión Digital
</div>
<div class="scrolling content" style="background-color:#EBEAE8;">
<form class="ui form">
<div class="field">
...
<script src="./res/tablas/tablaImpresion.js">
