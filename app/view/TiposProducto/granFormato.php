...
<modal-registrar id_form="frmRegistrar" id="modalRegistrar" url="?1=ProductosController&2=registrarG" titulo="Registrar producto"
    ...
    <modal-eliminar id_form="frmEliminar" id="modalEliminar" url="?1=ProductosController&2=eliminar" titulo="Eliminar producto"
        ...
        <div class="row">
                <div class="titulo">
                <a href="?1=ProductosController&2=granFormato" class="ui gray button" id="gr" style="color:black; font-weight:bold;">Gran Formato</a>
                ...
                <i class="calendar check outline icon"></i> <i class="truck icon"></i>
                    Productos de Gran Formato </font><font color="black" size="20px">.</font>
                </div>
...
<i class="pencil icon"></i> Colores disponibles en Productos de Gran Formato
</div>
...
<div class="header" style="font-size:17px; text-align:center; background-color:#89DE5F;font-weight:bold;">
<i class="podcast icon"></i> Lista de acabados disponibles en Productos de Gran Formato
</div>
<div class="scrolling content" style="background-color:#EBEAE8;">
<form class="ui form">
<div class="field">
...
<i class="arrows alternate icon"></i> Medidas disponibles en Productos de Gran Formato
</div>
<div class="scrolling content" style="background-color:#EBEAE8;">
<form class="ui form">
<div class="field">
...
<script src="./res/tablas/tablaGranFormato.js">
       ...
       var idProducto = $("#idProductoF").val();
        ...
        alertify.confirm("¿Desea eliminar el acabado del producto "+$("#titleDe").text()+" ?",
            function(){
               ...
               type: 'POST',
               url: '?1=OTController&2=eliminarAcabado',
               data: {
                   idProducto:idProducto,
                   idAcabado:idAcabado,
               },
