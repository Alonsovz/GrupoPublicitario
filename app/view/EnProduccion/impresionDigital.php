...
<div class="ui grid">
        <div class="row">
            <div class="titulo">
            <a href="?1=ProduccionController&2=granFormato" class="ui gray button" id="gr">Gran Formato</a>
            <a href="?1=ProduccionController&2=impresion" class="ui black button" id="imp" style="font-weight:bold;">Impresión Digital</a>
